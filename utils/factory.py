...
def get_metric_dict(cfg):
    ...
    if cfg.use_aux:
        metric_dict = {
            ...
            'op': [
                MultiLabelAcc(),
                AccTopk(cfg.griding_num, 2),
                AccTopk(cfg.griding_num, 3),
                Metric_mIoU(cfg.num_lanes + 1)
            ],
            'data_src': [('cls_out', 'cls_label'), ('cls_out', 'cls_label'),
